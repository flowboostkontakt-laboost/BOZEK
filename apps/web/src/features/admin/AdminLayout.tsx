    ...
    <div className="flex h-screen bg-bg text-ink">
      <aside className="flex w-64 shrink-0 flex-col border-r border-line bg-surface-1">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                [
                  ...
                  isActive
                    ? "bg-accent-soft text-ink shadow-[inset_0_0_0_1px_rgba(124,92,255,0.35)]"
        ...
        <div className="flex items-center gap-3 border-t border-line px-5 py-4">
          <div className="grid h-8 w-8 place-items-center rounded-full bg-surface-3 text-xs font-semibold">
            A
          </div>
          <div className="leading-tight">
